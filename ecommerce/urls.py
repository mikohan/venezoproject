...
from .views import home_page, about_page, contact_page, delivery_page, warraty_page, payment_page, send_mail_to
...
from .sitemaps import ProductSitemaps, CategoriesSitemaps, BlogsSitemaps
sitemaps = {
